 ...
 <?php		
	...
	if($_POST){
		...
		$sql = "UPDATE tblanimal SET nomeani = '".$nomeani."', nomecientificoani = '".$nomecieoani."', habitatani = '".$habitatani."', familiaani = '".$familiaani."', corani = '".$corani."', situaçãoani = '".$situaçãoani."', txtani = '".$txtani."', imgani = '".$imgani."' 
		WHERE id_ani = '".$id_ani."'";
...
                		}           	
                	else{
                    	document.frmWebPrincipal.action = './animal_alterar.php?acao=alterar';
...
                }
            	else{
                	document.frmWebPrincipal.action = './animal_alterar.php?acao=consultar';
                	document.frmWebPrincipal.submit();
                	return false;
            }
            }
                function fnLimparDados() {
                document.frmWebPrincipal.action = './animal_alterar.php?acao=limpar';
                document.frmWebPrincipal.submit();
                return false;
            }
			...
			<main>
			   ...
			   <form id="frmWebPrincipal" name="frmWebPrincipal" method="post" action="">
			   		<div class="campos">
						...
						<div class="alttexttrampo">Altere a imagem:</div><input class="tacaimg" type= "file" name= "imgani" id="imgani"></br>
							<div class="campoimg">
							...
							<textarea class="campotexto" name="txtani" id="txtani" value = "<?php echo "$txtani"?>" placeholder="Insira um breve texto sobre o animal" size = "150px" height=1000></textarea>	
