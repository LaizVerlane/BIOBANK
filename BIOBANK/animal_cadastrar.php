<?php		
	...
	if($_POST){
		...
		$sql =" insert into tblanimal (id_ani, nomeani, nomecientificoani, habitatani, familiaani, corani, situaçãoani, txtani, imgani)
...
                		}
                else{
                    document.frmWebPrincipal.action = './animal_cadastrar.php?acao=cadastrar';
...
                document.frmWebPrincipal.action = './animal_cadastrar.php?acao=limpar';
                document.frmWebPrincipal.submit();
                return false;
            }
	</script>
	...
	<div class="espacodokrl">
		<div class="centro">
			...
			<div class="cadastro col-10-lg">
				<main>
					<h2 class="tit">Cadastro de animal</h2>
