<?php		
	...
	if($_POST){
		...
		$sql = "DELETE FROM tblanimal WHERE id_pla = '".$id_ani."'";
...
                		}           	
                	else{
                    	document.frmWebPrincipal.action = './planta_deletar.php?acao=deletar';
...
                }
            	else{
                	document.frmWebPrincipal.action = './planta_deletar.php?acao=consultar';
                	document.frmWebPrincipal.submit();
                	return false;
            }
            }
                function fnLimparDados() {
                document.frmWebPrincipal.action = './planta_deletar.php?acao=limpar';
                document.frmWebPrincipal.submit();
                return false;
            }
			   ...
			   <form id="frmWebPrincipal" name="frmWebPrincipal" method="post" action="">
				   <div class="campos">
						...
						<div class="campinhoimg">
							<div class="campoimg">
								<img class="imgcadast" src = "./img_pla/<?php echo "$imgani"?>">	
							</div>
		

						</div>	
						
						<textarea class="campotexto" type="text" name="txtani" id="txtani" value = "<?php echo "$txtani"?>" placeholder="Insira um breve texto sobre a planta" size = "150px" height=1000></textarea>	
					</div>
